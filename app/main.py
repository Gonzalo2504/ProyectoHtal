...
from app.routes import paciente_routes, medico_routes, enfermero_routes, administrador_routes, login_routes, triage_routes, ordenesMedicas_routes, evoluciones_routes, eventos_routes
